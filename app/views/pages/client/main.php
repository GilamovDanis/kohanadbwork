<h3>Все клиенты  -  <?php echo HTML::anchor('client/add', ' Добавить клиента',array('class'=>'btn btn-default btn-sm')); ?> &nbsp; <?php echo HTML::anchor('client/search/?newsearch=1', ' Поиск клиента',array('class'=>'btn btn-default btn-sm')); ?></h3> 
...
<thead>
	...
	<tr>
		...
		<td>
		<?php echo $message->discount->name; ?>
		</td>
