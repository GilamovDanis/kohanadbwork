<form action="/room/search/" class="form-horizontal" role="form" method="post">
<fieldset>
<legend>Поиск комнаты</legend>
<br />
			...
			<label for="status" class="col-sm-3 control-label">Статус комнаты</label>
				...
				<?php 
				$rooms_status=array('not'=>'-Не выбрано-','free'=>'Свободна','close'=>'Занята','reserv'=>'Бронь');
